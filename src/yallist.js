...
Yallist.prototype.size = function () {
    return this.length;
}
Yallist.prototype.first = function () {
    return this.head;
}
Yallist.prototype.last = function () {
    return this.tail;
}
...
function push(self, item) {
    let node = new Node(item, self.tail, null, self)
    self.tail = node;
    if (!self.head) {
        self.head = self.tail
    }
...
function unshift(self, item) {
    let node = new Node(item, null, self.head, self)
    self.head = node;
    if (!self.tail) {
        self.tail = self.head
    }
...
Node.prototype.remove = function () {
    if (!(this.list instanceof Yallist)) {
        return false;
    }
